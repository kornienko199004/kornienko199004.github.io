...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        ...
        this.data.forEach(function (_a) {
            var type = _a.type;
            _this.types.add(type);
        });
        this.type = this.types.values().next().value;
    }
    AppComponent.prototype.onChangeIndex = function (index) {
        this.index = index;
    };
    AppComponent.prototype.onChangeType = function (type) {
        this.type = type;
    };
...
var MainCardComponent = /** @class */ (function () {
    ...
    MainCardComponent.prototype.onSelectType = function (type) {
        this.hotelIndex = 0;
        this.type = type;
        this.changedType.emit(this.type);
        this.changedIndex.emit(this.hotelIndex);
    };
    MainCardComponent.prototype.onChooseHotel = function (index) {
...
var FilterPipe = /** @class */ (function () {
    ...
    FilterPipe.prototype.transform = function (value, currentType, types) {
        var selectedType = currentType ? currentType : types.values().next().value;
